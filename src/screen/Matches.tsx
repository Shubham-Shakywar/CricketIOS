...
function Live(props: HomeProps) {
  ...
  {matchItem.matchScore && matchItem.matchScore.team2Score && matchItem.matchScore.team2Score.inngs1
    ...
    : null}
      ...
      {isCurrentMatchType && !hasMatches && (
        <View style={{ alignItems: 'center', marginVertical: 20 }}>
          <Image source={require('../../assets/sad.png')} style={{ height: 200, width: 200 }} />
        </View>
      )}
    </View>
  );
  ...
  return (
    ...
    refreshControl={
      <RefreshControl
        ...
        onRefresh={onRefresh}
        colors={['#0000ff']} // Set the colors for the loader
        tintColor={'#0000ff'} // Set the tint color for the loader on Android
      />
    }>
