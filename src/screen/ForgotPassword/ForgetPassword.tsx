...
// import {Text, SafeAreaView, StyleSheet, TouchableOpacity, TextInput, Pressable, Alert} from 'react-native';
...
//       const apiUrl = `https://cricketwicket.biz/api/v1/auth/forgot-password?email=${email}`;
...
//       <Text style={styles.headerTxt}>Enter your email</Text>
//       <TextInput
//         style={styles.input}
//         placeholder="Email"
